...
public class MlEpisode implements Serializable {
	...
	public void setMediaTelecharge(File mediaTelecharge) {
		this.mediaTelecharge = mediaTelecharge;
	}

	public File getMediaTelecharge() {
		return mediaTelecharge;
	}
}
