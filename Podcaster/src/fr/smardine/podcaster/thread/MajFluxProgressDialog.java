...
public class MajFluxProgressDialog {
	 ...
	 */
	public void synchroMajFluxProgressDialog(Context p_context, EnMethodType p_method, List<MlFlux> p_listeFlux, ListView p_listView) {
		mycontext = p_context;
		...
		try {
			final HandlerMajFluxProgressDialog progressDialogHandler = new HandlerMajFluxProgressDialog(mycontext, method,
					date_EtatSynchro, false);

			new ThreadExecutionMajFlux(mycontext, method, progressDialogHandler, p_listeFlux, p_listView).start();
